    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=250, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Username must be at least 8 characters long and contain at least one uppercase letter.', regex='^(?=.*[A-Z]).{8,}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, default='regular', max_length=11, null=True)),
